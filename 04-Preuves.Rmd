...
1ere preuve:
```{proof}
1er lemme: Soit une V.A. $X$ quelconque, dont $E[X]<\infty$.   
...
$$
```{r,echo=FALSE}
y <- function(x) x +10*exp(-x)
plot(y,xlim=c(0,3),ylim=c(0,10),main="Exemple: X~Exp(1) et kappa=0.9" ,ylab=expression(phi(x)))
points(qexp(0.9),y(qexp(0.9)),pch=19)
legend("bottomleft",legend=expression(VaR),pch=19)
```  
