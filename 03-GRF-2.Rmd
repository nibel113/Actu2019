...
legend("topleft",c('Foward',"Valeur échéance","Profit"),col=c("red","blue","green"),lty=c(1,2,3),lwd=2)
abline(h=0)
points(2,0,pch=19)
x <- c(0,4)
y <- c(2,-2)
...
curve(fx,col='blue',add=TRUE,lty=2,lwd=2)
curve(fy,col="green",add=TRUE,lty=3,lwd=2)
legend("bottomleft",c('Foward',"Valeur échéance","Profit","Stike price(K)"),col=c("red","blue","green",1),lty=c(1,2,3,NA),pch=c(NA,NA,NA,19),lwd=2)
abline(h=0)
points(2,0,pch=19)
par(op)
```
...
curve(fx,col='blue',add=TRUE,lty=2,lwd=2)
curve(fy,col="green",add=TRUE,lty=3,lwd=2)
legend("bottomright",c('Foward',"Valeur échéance","Profit","Stike price(K)"),col=c("red","blue","green",1),lty=c(1,2,3,NA),pch=c(NA,NA,NA,19),lwd=2)
abline(h=0)
points(2,0,pch=19)
```
